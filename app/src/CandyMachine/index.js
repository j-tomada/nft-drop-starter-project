...
const CandyMachine = ({ walletAddress }) => {
  ...
  const getProvider = () => {
    ...
    //Creaing Solana provider object
  ...
  const renderMintedItems = () => (
    <div className='gif-container'>
      ...
      <div className='gif-grid'>
        {mints.map((mint) => (
          <div className='gif-items' key={mint}>
  ...
  const renderDropTimer = () => {
    // Get current date and dropDate
    const currentDate = new Date();
    const dropDate = new Date(machineStats.goLiveDate * 1000);

    // render Countdown component if currentDate is before dropDate
    ...
    machineStats && (
      <div className="machine-container">
        ...
        <p>{`Items Minted: ${machineStats.itemsRedeemed} / ${machineStats.itemsAvailable}`}</p>
          {/* Checking to see if properties are equal! */}
        ...
        {/* If we have mints available in our array, we should render it on screen */}
